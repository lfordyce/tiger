...
// Worker is a single processor. Typically, it's possible to
...
func callJob(job Job) {
	fmt.Printf("Hostname ID: %s Start Time: %s, End Time: %s\n", job.ID, job.StartTime, job.EndTime)
}
